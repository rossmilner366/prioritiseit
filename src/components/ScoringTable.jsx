        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-white/[0.06]">
              ...
              {scoringModel === 'rice' && (
                <th className="py-3 px-1 text-xs font-medium text-slate-500 uppercase tracking-wider w-16">Reach</th>
              )}
              <th className="py-3 px-1 text-xs font-medium text-slate-500 uppercase tracking-wider w-16">Impact</th>
              <th className="py-3 px-1 text-xs font-medium text-slate-500 uppercase tracking-wider w-16">Conf.</th>
              <th className="py-3 px-1 text-xs font-medium text-slate-500 uppercase tracking-wider w-16">
